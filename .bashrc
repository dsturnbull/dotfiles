...
export PATH=$HOME/src/flex/bin:/opt/local/lib/postgresql83/bin:$CRYSTAL/bin:/opt/local/sbin:/opt/local/bin:/opt/ruby-enterprise/bin:$HOME/local/bin:$PATH:$HOME/bin:$HOME/.cabal/bin
